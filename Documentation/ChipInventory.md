...
LVC column exists only for the 74LVC245 3.3 V stock.
...
| Part   | Function                                  | HC  | HCT | LS              | LVC             | HC In | HCT In |
| ------ | ----------------------------------------- | --- | --- | --------------- | --------------- | ----- | ------ |
| 7400   | 4× 2i NAND                                | 11  |     |                 |                 |       |        |
| 7402   | 4× 2i NOR                                 | 11  |     |                 |                 |       |        |
...
| 74181  | 4-Bit ALU (LS — needs HCT fence)          |     |     | <mark>32</mark> |                 |       |        |
...
| 74245  | Octal Bus Transceiver                     | 16  | 20  |                 | <mark>10</mark> |       |        |
...
| 74688  | 8-Bit Identity Comparator                 | 4   | 3   |                 |                 |       |        |
...
- **LVC is a 3.3 V family (Vcc 1.65–3.6 V) — never put it on the 5 V rail.** Inputs
  are 5 V tolerant when the part is powered at 3.3 V, so the 74LVC245 is usable as a
  5 V→3.3 V input buffer, but its outputs will not meet a 5 V HC input threshold.
  Keep it out of the HC/HCT drawers.
