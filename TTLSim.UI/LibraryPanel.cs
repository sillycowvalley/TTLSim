...
public sealed class LibraryPanel : UserControl
{
    ...
    private static readonly HashSet<string> SimulatedChipIdentifiers = new(StringComparer.Ordinal)
    {
        ...
        "47", "74", "125", "126", "138", "139", "151", "153", "154", "157", "161", "163", "173", "181", "182", "191", "194", "244", "245", "257", "273", "283", "299", "374", "377", "390", "393", "541", "573", "574", "670", "688",
        "DS1813",
        "7seg-ca",
        "NE555", "NE556",
    ...
    private void PopulateLibrary()
    {
        ...
        AddPart(passive, "Resistor Network, isolated (DIP-16)", PassivePartDefinition.ResistorNetworkDip16);
