...
/// <summary>One 2-input AND gate from a 74HC08. tPD ~10 ns.</summary>
public sealed class Hc08 : IChip
{
    ...
    public Hc08(Net inputA, Net inputB, Net output, long delayPs = PropagationDelayPs)
    {
        this.inputA = inputA;
        this.inputB = inputB;
        this.output = output;
